		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t014",targetState="timerStart",cond=whenDispatch("prepare"))
				}	 
				state("timerStart") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t015",targetState="timerStart",cond=whenDispatch("repeat"))
					transition(edgeName="t016",targetState="waitCmd",cond=whenDispatch("clear"))
				}	 
